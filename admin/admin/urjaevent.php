...
if (!isset($_SESSION['adminData'])) {
  ...
  if (!$con) {
    ...
    $sql = "SELECT * FROM " . DB_URJA_TBL . " ORDER BY catid ASC";
...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO " . DB_URJA_TBL . " VALUES('', '" . $category_name . "', '" . $pdf_name . "')";
  // echo $sql;
  // die();
  $result = mysqli_query($con, $sql);
  ...
  if ($result) {
    $_SESSION['msg'] = "
      <div class='alert alert-success alert-dismissible fade show my-3'>
          <strong>Success!</strong> New Urja Fest Report Added!
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE " . DB_URJA_TBL . " SET category_name = '" . $category_name . "', category_image = '" . $image_name . "', category_image = '" . $pdf_name . "' WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);

  if ($result) {
    $_SESSION['msg'] = "
      <div class='alert alert-success alert-dismissible fade show my-3'>
          <strong>Success!</strong> Urja Fest Report Updated!
          <button type='button' class='btn-close' data-bs-dismiss='alert'></button>
      </div>
      ";
  } else {
...
if (isset($_POST['delete'])) {
  ...
  $sql = "DELETE FROM " . DB_URJA_TBL . " WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);

  if ($result) {
    $_SESSION['msg'] = "
        <div class='alert alert-success alert-dismissible fade show my-3'>
            <strong>Success!</strong> Urja Fest Report Deleted!
            <button type='button' class='btn-close' data-bs-dismiss='alert'></button>
        </div>
        ";
  } else {
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Urja Fest Report</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales">
                ...
                <div class="card-body">
                  <h5 class="card-title">Urja Fest Report<span></span></h5>
                  ...
                  <div class="mb-4">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addForm_modal">Add New Urja Fest</button>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-borderless datatable">
                      <thead>
                        <tr>
                          <th scope="col">#ID</th>
                          <th scope="col">Urja Fest Name</th>
                          <th scope="col">Urja Fest PDF</th>
                        ...
                        ?>
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="staticBackdropLabel">Update Urja Fest</h5>
                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                  <p class="statusMsg"></p>
                                  <!-- Multi Columns Form -->
                                  <form class="row g-3" method="POST" action="urjaevent.php" enctype='multipart/form-data'>
                                    <div class="col-md-12 mt-3">
                                      <label for="category_name" class="form-label">Urja Fest Year</label>
                                    ...
                                    <div class="col-md-12 col-12 mt-3">
                                      <label for="category_image" class="form-label">Urja Fest PDF</label><br>
                          ...
                          <div class="modal fade" id="delete_modal<?php echo $row['catid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Delete Urja Fest</h5>
                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                  <p>Are you sure you want to delete this Urja Fest?</p>
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                  <form class="row g-3" method="POST" action="urjaevent.php" enctype='multipart/form-data'>
    ...
    <div class="modal fade" id="addForm_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Add Sports</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <p class="statusMsg"></p>
            ...
            <form class="row g-3" method="POST" action="urjaevent.php" enctype='multipart/form-data'>
              ...
              <div class="col-md-12 col-12">
                <label for="category_image" class="form-label">Urja Fest PDF</label>
                <input class="form-control" id="category_image" name="category_image" type="file">
              </div>
