...
if (!isset($_SESSION['adminData'])) {
  ...
  if (!$con) {
    ...
    $sql = "SELECT * FROM " . DB_SPORTSEVENT_TBL . " ORDER BY catid ASC";
...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO " . DB_SPORTSEVENT_TBL . " VALUES('', '" . $category_name . "', '" . $pdf_name . "')";
  // echo $sql;
  // die();
  $result = mysqli_query($con, $sql);
  ...
  if ($result) {
    $_SESSION['msg'] = "
      <div class='alert alert-success alert-dismissible fade show my-3'>
          <strong>Success!</strong> New Sports Report Added!
  ...
  header("Location: sportsevent.php");
}
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE " . DB_SPORTSEVENT_TBL . " SET category_name = '" . $category_name . "', category_image = '" . $image_name . "', category_image = '" . $pdf_name . "' WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);

  if ($result) {
    $_SESSION['msg'] = "
      <div class='alert alert-success alert-dismissible fade show my-3'>
          <strong>Success!</strong> Sports Report Updated!
          <button type='button' class='btn-close' data-bs-dismiss='alert'></button>
      </div>
      ";
  } else {
...
if (isset($_POST['delete'])) {
  ...
  $sql = "DELETE FROM " . DB_SPORTSEVENT_TBL . " WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);

  if ($result) {
    $_SESSION['msg'] = "
        <div class='alert alert-success alert-dismissible fade show my-3'>
            <strong>Success!</strong> Sports Report Deleted!
            <button type='button' class='btn-close' data-bs-dismiss='alert'></button>
        </div>
        ";
  } else {
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sports Report</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sports Report<span></span></h5>
                  ...
                  <div class="mb-4">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addForm_modal">Add New Sports</button>
                  </div>
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="staticBackdropLabel">Update Sports</h5>
                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                  <p class="statusMsg"></p>
                                  <!-- Multi Columns Form -->
                                  <form class="row g-3" method="POST" action="sportsevent.php" enctype='multipart/form-data'>
                                    <div class="col-md-12 mt-3">
                                      <label for="category_name" class="form-label">Sports Year</label>
                                    ...
                                    <div class="col-md-12 col-12 mt-3">
                                      <label for="category_image" class="form-label">Sports PDF</label><br>
          ...
          <div class="modal-body">
            ...
            <form class="row g-3" method="POST" action="sportsevent.php" enctype='multipart/form-data'>
              ...
              <div class="col-md-12 col-12">
                <label for="category_image" class="form-label">Sports PDF</label>
                <input class="form-control" id="category_image" name="category_image" type="file">
              </div>
