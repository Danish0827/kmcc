...
if (!isset($_SESSION['adminData'])) {
  ...
  if (!$con) {
    ...
    $sql = "SELECT * FROM " . DB_NOTICENEW_TBL . " ORDER BY catid ASC";
...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO " . DB_NOTICENEW_TBL . " (category_name, category_desc) VALUES (?, ?)";
...
if (isset($_POST['update'])) {
  ...
  // }
  $sql = "UPDATE " . DB_NOTICENEW_TBL . " SET category_name = ?, category_desc = ? WHERE catid = ?";
...
if (isset($_POST['delete'])) {
  ...
  $sql = "DELETE FROM " . DB_NOTICENEW_TBL . " WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p class="statusMsg"></p>
                                  <!-- Multi Columns Form -->
                                  <form class="row g-3" method="POST" action="noticenew.php" enctype='multipart/form-data'>
                                    <div class="col-md-12 mt-3">
                                      <label for="category_name" class="form-label">Notice Name</label>
                                    ...
                                    <div class="col-md-12 mt-3">
                                      <label for="category_desc" class="form-label">URL</label>
                                      <input type="url" class="form-control" id="category_desc" name="category_desc" value="<?php echo $row['category_desc'] ?>" required>
                                    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="row g-3" method="POST" action="noticenew.php" enctype='multipart/form-data'>
              ...
              <div class="col-md-12">
                <label for="category_desc" class="form-label">URL</label>
                <input type="url" class="form-control" id="category_desc" name="category_desc">
              </div>
