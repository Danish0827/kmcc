...
if (!isset($_SESSION['adminData'])) {
  ...
  if (!$con) {
    ...
    $sql = "SELECT * FROM " . DB_TEACHINGDE_TBL . " ORDER BY catid ASC";
...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO " . DB_TEACHINGDE_TBL . " VALUES('', '" . $category_name . "', '" . $img . "', '" . $category_desc . "')";
  $result = mysqli_query($con, $sql);
  ...
  header("Location: teachingdegree.php");
}
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE " . DB_TEACHINGDE_TBL . " SET category_name = '" . $category_name . "', category_desc = '" . $category_desc . "', category_image = '" . $img . "' WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);
...
if (isset($_POST['delete'])) {
  ...
  $sql = "DELETE FROM " . DB_TEACHINGDE_TBL . " WHERE catid = " . $catid;
  $result = mysqli_query($con, $sql);
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Teaching Degree</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales">
                ...
                <div class="card-body">
                  <h5 class="card-title">Teaching Degree<span></span></h5>
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p class="statusMsg"></p>
                                  <!-- Multi Columns Form -->
                                  <form class="row g-3" method="POST" action="teachingdegree.php" enctype='multipart/form-data'>
                                    ...
                                    <div class="col-md-12 mt-3">
                                      ...
                                      <input class="form-control" id="category_desc" name="category_desc" value="<?php echo $row['category_desc'] ?>" required></input>
                                    </div>
